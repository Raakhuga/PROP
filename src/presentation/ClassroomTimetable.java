...
public class ClassroomTimetable extends javax.swing.JFrame {
    ...
    public ClassroomTimetable(PresentationCtrl presentationctrl) {
        ...
        timetable.setLocation(0, 0);
        //timetable.setSize(80, 40);
        timetable.setEnabled(true);
        timetable.setVisible(true);
        backButton.setLocation(this.getWidth()-200, this.getHeight() - 200);
        //backButton.setSize(30,20);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        generateButtons();
        this.setSize(240+(act.getdEnd())*160, 240+(act.gethEnd()-act.gethIni())*60);
